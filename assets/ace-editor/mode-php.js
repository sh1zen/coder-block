ace.define(
		...
		function ( e, t, n ) {
			...
			var r = e( '../lib/oop' ),
				...
				u = function ( e ) {
					...
					this.embedRules( i, 'doc-', [
						i.getEndRule( 'no_regex' ),
					] ),
						this.normalizeRules();
				};
	...
	ace.define(
		...
		function ( e, t, n ) {
			...
			var r = e( '../lib/oop' ),
				...
				o = e( './javascript_highlight_rules' )
	...
	ace.define(
		...
		function ( e, t, n ) {
			...
			var r = e( '../lib/oop' ),
				i = e( '../lib/lang' ),
				s = e( './doc_comment_highlight_rules' )
					.DocCommentHighlightRules,
	...
	ace.define(
		...
		function ( e, t, n ) {
			...
			var r = e( '../lib/oop' ),
				i = e( './text' ).Mode,
				s = e( './javascript_highlight_rules' )
					.JavaScriptHighlightRules,
