( function () {
	...
	var t = function ( e, n, r ) {
		...
		arguments.length == 2 && ( r = n ),
			t.modules[ e ] ||
				( ( t.payloads[ e ] = r ), ( t.modules[ e ] = null ) );
	};
			...
			if ( ! Object.create ) {
				...
				Object.prototype.__proto__ === null
					...
					( Object.create = function ( t, n ) {
						...
						return (
							n !== void 0 && Object.defineProperties( r, n ), r
						);
					} );
			}
	...
	ace.define(
		...
		function ( e, t, n ) {
			...
			if ( typeof document != 'undefined' ) {
				...
				typeof i.style.animationName != 'undefined' &&
	...
	ace.define(
		...
		function ( e, t, n ) {
			...
			( t.isWin = r == 'win' ),
				...
				( t.isChrome =
					parseFloat( i.split( ' Chrome/' )[ 1 ] ) || undefined ),
					...
					r.addListener( c, 'compositionstart', B ),
						...
						( this.moveToMouse = function ( e, n ) {
							...
							var o = t.container.getBoundingClientRect(),
								...
								a =
									o.top +
									( parseInt( u.borderTopWidth ) || 0 ),
								f =
									o.left +
									( parseInt( o.borderLeftWidth ) || 0 ),
					...
					r.addListener( n, 'compositionstart', j ),
						...
						( this.moveToMouse = function ( e, o ) {
							...
							var u = t.container.getBoundingClientRect(),
								...
								f =
									u.top +
									( parseInt( a.borderTopWidth ) || 0 ),
								l =
									u.left +
									( parseInt( u.borderLeftWidth ) || 0 ),
			...
			( function () {
				( this.onMouseDown = function ( e ) {
					...
					( this.extendSelectionBy = function ( e ) {
						...
						if ( this.$clickSelection ) {
							var s = this.$clickSelection.comparePoint(
									i.start
								),
		...
		function ( e, t, n ) {
			...
			function u( e ) {
				function l() {
					...
					if ( r == o ) {
						var a = t.renderer.pixelToScreenCoordinates( 0, u.y )
								.row,
							l = u.$pos;
						if (
							a > t.session.documentToScreenRow( l.row, l.column )
						)
							return c();
					}
					if ( f == s ) return;
				...
				( this.isBidiRow = function ( e, t, n ) {
					...
					( this.updateRowLine = function ( e, t ) {
						...
						this.line = this.line.replace(
							...
							function ( e, t ) {
								return e === '	' ||
									s.isFullWidth( e.charCodeAt( 0 ) )
									? ( ( u =
											e === '	'
												? s.getScreenTabSize( t + o )
												: 2 ),
									  ( o += u - 1 ),
					...
					( this.updateCharacterWidths = function ( e ) {
						...
						var t = ( this.characterWidth =
								e.$characterSize.width ),
							n = e.$measureCharWidth( '\u05d4' );
						( this.charWidths[ r.L ] = this.charWidths[
							r.EN
						] = this.charWidths[ r.ON_R ] = t ),
							( this.charWidths[ r.R ] = this.charWidths[
								r.AN
							] = n ),
							( this.charWidths[ r.R_H ] = s.isChrome
								? n
								: n * 0.45 ),
					...
					( this.getPosLeft = function ( e ) {
						e -= this.wrapIndent;
						var t = r.getVisualFromLogicalIdx(
								e > 0 ? e - 1 : 0,
								this.bidiMap
							),
					...
					( this.offsetToCol = function ( e ) {
						...
						this.wrapIndent &&
							( e -= this.wrapIndent * this.charWidths[ r.L ] );
						while ( e > n + o / 2 ) {
							n += o;
							if ( i === s.length - 1 ) {
								o = 0;
			...
			var r = e( './lib/oop' ),
				...
				u = function ( e ) {
					( this.session = e ),
						...
						this.clearSelection(),
						( this.cursor = this.lead = this.doc.createAnchor(
							0,
							0
						) ),
				...
				r.implement( this, s ),
					...
					( this.moveCursorRight = function () {
						var e = this.lead.getPosition(),
							t;
						if (
							( t = this.session.getFoldAt( e.row, e.column, 1 ) )
						)
					...
					( this.toJSON = function () {
						if ( this.rangeCount )
							var e = this.ranges.map( function ( e ) {
								var t = e.clone();
								return (
									( t.isBackwards = e.cursor == e.start ), t
								);
							} );
						else {
							var e = this.getRange();
	...
	ace.define(
		...
		function ( e, t, n ) {
			...
			( d.isSaneInsertion = function ( e, t ) {
				...
				if (
					! this.$matchTokenType( r.getCurrentToken() || 'text', u )
				) {
				...
				( d.recordMaybeInsert = function ( e, t, n ) {
					...
					this.isMaybeInsertedClosing( r, i ) ||
						...
						( f.maybeInsertedLineStart =
							i.substr( 0, r.column ) + n ),
				...
				( d.popAutoInsertedClosing = function () {
					( f.autoInsertedLineEnd = f.autoInsertedLineEnd.substr(
						1
					) ),
						f.autoInsertedBrackets--;
				} ),
					...
					case 'insert':
						...
						if ( o.length === 1 )
							...
							e.splice.apply( e, u ),
								...
								( e[ r + t.lines.length - 1 ] += s.substring(
									i
								) );
						}
						break;
			...
			( function () {
				r.implement( this, s ),
					( this.setValue = function ( e ) {
						...
						this.remove(
							new o( 0, 0, t, this.getLine( t ).length )
						),
							this.insert( { row: 0, column: 0 }, e );
					} ),
				...
				function () {
					...
					( this.$computeWrapSplits = function ( e, r, i ) {
						...
						( this.getScreenLastRowColumn = function ( e ) {
							...
							return this.documentToScreenColumn(
								t.row,
								t.column
							);
						} ),
				...
				( this.set = function ( e ) {
					...
					( this.replace = function ( e, t ) {
						...
						if ( n.preserveCase ) {
							t = t.split( '' );
							for (
								var s = Math.min( e.length, e.length );
								s--;
					...
					( this.$assembleRegExp = function ( e, t ) {
						...
						e.$isMultiLine = ! t && /[\n\r]/.test( n );
						if ( e.$isMultiLine )
							return ( e.re = this.$assembleMultilineRegExp(
								n,
								i
							) );
						try {
					...
					( this.addCommand = function ( e ) {
						...
						( this.handleKeyboard = function ( e, t, n, r ) {
							...
							e.$keyChain &&
								( ( e.$keyChain += ' ' + i ),
								( o =
									this.commandKeyBinding[ e.$keyChain ] ||
									o ) );
							if ( o )
								if (
									o == 'chainKeys' ||
		...
		function ( e, t, n ) {
			...
			t.commands = [
				...
				},
				{
					...
					exec: function ( e, t ) {
						e.insert(
							r.stringRepeat( t.text || '', t.times || 1 )
						);
					},
					multiSelectAction: 'forEach',
					scrollIntoView: 'cursor',
					...
					exec: function ( e ) {
						...
						i.row + 1 < e.session.doc.getLength() - 1 &&
							...
							a > 0
								...
								: ( ( o =
										e.session.doc.getLine( n.row ).length >
										o
											? o + 1
											: o ),
					...
					r.implement( this, d ),
						...
						( this.$updateHighlightActiveLine = function () {
							...
							if ( e.$highlightLineMarker && ! t )
								...
								t &&
									( ( e.$highlightLineMarker.start.row =
										t.row ),
						...
						( this.getCopyText = function () {
							...
							if ( ! e && this.$copyWithEmptySelection ) {
								...
								for ( var i = 0; i < r.length; i++ ) {
									...
									if (
										i &&
										r[ i - 1 ].start.row == s.start.row
									)
										continue;
									e +=
										this.session.getLine( s.start.row ) + t;
								}
							}
							var o = { text: e };
							return (
						...
						( this.$getSelectedRows = function ( e ) {
							return (
								...
								).collapseRows() ),
								{
									...
									last: this.session.getRowFoldEnd(
										e.end.row
									),
								}
							);
						...
						( this.$moveByPage = function ( e, t ) {
							...
							n.scrollBy( 0, i * r.lineHeight ),
								t != null &&
									n.scrollCursorIntoView( null, 0.5 ),
					...
					( this.update = function ( e ) {
						...
						for (;;) {
							...
							if ( u ) {
								var y = u[ v ];
								y == null &&
									( y = u[ v ] = t.getFoldWidget( v ) );
							}
							if ( y ) {
								p.foldWidget ||
									( ( p.foldWidget = r.createElement(
										'span'
									) ),
			...
			var r = e( '../lib/oop' ),
				...
				a = function ( e ) {
					( this.element = i.createElement( 'div' ) ),
						...
						e.appendChild( this.element ),
						( this.$updateEolChar = this.$updateEolChar.bind(
							this
						) );
				};
			( function () {
				r.implement( this, u ),
					...
					( this.renderIndentGuide = function ( e, t, n ) {
						...
						return r <= 0 || r >= n
							...
							: t[ 0 ] == '	'
							? ( e.push(
									s.stringRepeat( this.$tabStrings[ '	' ], r )
							  ),
							  t.substr( r ) )
							: t;
					} ),
			...
			var r = e( '../lib/dom' ),
				...
				s = function ( e ) {
					( this.element = r.createElement( 'div' ) ),
						...
						e.appendChild( this.element ),
						i === undefined &&
							( i = ! ( 'opacity' in this.element.style ) ),
						( this.isVisible = ! 1 ),
						( this.isBlinking = ! 0 ),
				...
				( this.$updateVisibility = function ( e ) {
					...
					( this.setSmoothBlinking = function ( e ) {
						e != this.smoothBlinking &&
							...
							( this.$updateCursors = this.$updateOpacity.bind(
								this
							) ),
							this.restartTimer() );
					} ),
					...
					( this.getPixelPosition = function ( e, t ) {
						...
						var n = this.session.documentToScreenPosition( e ),
							...
							i =
								( n.row -
									( t ? this.config.firstRowScreen : 0 ) ) *
								this.config.lineHeight;
						return { left: r, top: i };
					} ),
					( this.update = function ( e ) {
			...
			var r = e( '../lib/oop' ),
				...
				h = ( t.FontMetrics = function ( e ) {
					( this.el = i.createElement( 'div' ) ),
						...
						( this.$measureNode.innerHTML = s.stringRepeat(
							'X',
							f
						) ),
		...
		function ( e, t, n ) {
			...
			var g = function ( e, t ) {
				...
				( this.canvas = r.element ),
					...
					( this.$horizScroll = ! 1 ),
					( this.$vScroll = ! 1 ),
					( this.scrollBar = this.scrollBarV = new h(
						this.container,
						this
					) ),
					...
					this.scrollBarV.addEventListener( 'scroll', function ( e ) {
						n.$scrollAnimation ||
							n.session.setScrollTop(
								e.data - n.scrollMargin.top
							);
					} ),
				...
				( this.CHANGE_CURSOR = 1 ),
					...
					( this.$updatePrintMargin = function () {
						...
						if ( ! this.$printMarginEl ) {
							...
							( e.className =
								...
								( this.$printMarginEl = i.createElement(
									'div'
								) ),
					...
					( this.$moveTextAreaToCursor = function () {
						...
						if ( this.$composition ) {
							...
							( s *=
								this.session.$getStringScreenWidth( o )[ 0 ] +
								2 ),
								( i += 2 );
						}
						( r -= this.scrollLeft ),
							...
							( e.width = s + 'px' ),
							( e.left =
								Math.min( r, this.$size.scrollerWidth - s ) +
								'px' ),
							( e.top =
					...
					( this.$updateScrollBarV = function () {
						...
						! this.$maxLines &&
							this.$scrollPastEnd &&
							( ( e -=
								( t - this.lineHeight ) * this.$scrollPastEnd ),
							this.scrollTop > e - t &&
								( ( e = this.scrollTop + t ),
					...
					highlightGutterLine: {
						set: function ( e ) {
							if ( ! this.$gutterLineHighlight ) {
								( this.$gutterLineHighlight = i.createElement(
									'div'
								) ),
		...
		function ( e, t, n ) {
			...
			var r = e( '../lib/oop' ),
				...
				f = function ( t, n, r, i, s ) {
					( this.$sendDeltaQueue = this.$sendDeltaQueue.bind(
						this
					) ),
		...
		function ( e, t, n ) {
			...
			function m( e ) {
				...
				( e.$onAddRange = e.$onAddRange.bind( e ) ),
					...
					( e.$multiselectOnSessionChange = t.onSessionChange.bind(
						e
					) ),
		...
		function ( e, t, n ) {
			...
			function o( e ) {
				( this.session = e ),
					...
					( this.$onChangeEditor = this.$onChangeEditor.bind(
						this
					) ),
				...
				( this.getRowLength = function ( e ) {
					...
					( this.measureWidgets = function ( e, t ) {
						...
						for ( var s = 0; s < n.length; s++ ) {
							...
							o.coverLine &&
								( ( u -= this.session.getRowLineCount(
									o.row
								) ),
								u < 0 && ( u = 0 ) ),
								o.rowCount != u &&
